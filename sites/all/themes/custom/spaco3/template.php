 ...
 */
function spaco3_preprocess_html(&$vars) {
  global $theme_key;
 ...
 */
function spaco3_preprocess_atpe_site_template(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Preprocess Site Template
 */
function spaco3_preprocess_atpe_site_template_fww(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 */
function spaco3_preprocess_pane_header(&$vars) {
  global $theme_key;
  $theme_name = $theme_key;
 ...
 * Process pane header
 */
function spaco3_process_pane_header(&$vars) {
 ...
 */
function spaco3_preprocess_pane_navigation(&$vars) {
 ...
 * Preprocess pane navigation vars
 */
function spaco3_process_pane_navigation(&$vars) {
  // theme the menu bars
...
function spaco3_preprocess_pane_messages(&$vars) {
